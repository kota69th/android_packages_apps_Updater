...
public final class Constants {
    ...
    public static final String PROP_RELEASE_TYPE = "ro.cherish.build_type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "cherish.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "cherish.updater.uri";
